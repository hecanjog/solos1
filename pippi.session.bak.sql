...
INSERT INTO "shared" VALUES('count','24');
CREATE TABLE voices (
...
INSERT INTO "voices" VALUES(1,0,0,1.0,1.0,0,0,1,14,0,0,'be');
INSERT INTO "voices" VALUES(2,0,0,1.0,1.0,0,0,1,6,0,0,'be');
INSERT INTO "voices" VALUES(3,0,1,1.0,1.0,0,0,1,5,0,0,'be');
CREATE TABLE params (
    id integer primary key,
    name text,
    shortname text,
...
INSERT INTO "params" VALUES(1,'generator','be',NULL,'string','be','be',1,'["alphanumeric"]',NULL);
INSERT INTO "params" VALUES(2,'device','device',NULL,'string','T6_pair1','T6_pair1',1,'["alphanumeric"]',NULL);
INSERT INTO "params" VALUES(3,'bpm','bpm',NULL,'float','80.0','80.0',1,'["float", "integer"]',NULL);
INSERT INTO "params" VALUES(4,'generator','be',NULL,'string','be','be',2,'["alphanumeric"]',NULL);
INSERT INTO "params" VALUES(5,'device','device',NULL,'string','T6_pair1','T6_pair1',2,'["alphanumeric"]',NULL);
INSERT INTO "params" VALUES(6,'bpm','bpm',NULL,'float','80.0','80.0',2,'["float", "integer"]',NULL);
INSERT INTO "params" VALUES(7,'generator','be',NULL,'string','be','be',3,'["alphanumeric"]',NULL);
INSERT INTO "params" VALUES(8,'device','device',NULL,'string','T6_pair1','T6_pair1',3,'["alphanumeric"]',NULL);
